...
/**
 * Finestra principale. Coordina la gara: crea i Corridori (Subject),
 * registra l'AscoltatoreCorsore (Observer) e avvia i thread.
 */
public class Staffetta extends javax.swing.JFrame {
    ...
    private final Corridori[] corridori = new Corridori[4];
    ...
    private GestoreNotifiche.AscoltatoreCorsore ascoltatore;
    ...
    private void btnSospendiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSospendiActionPerformed
        for (Corridori c : corridori) if (c != null) c.setSospeso(true);
    ...
    private void btnRiprendiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRiprendiActionPerformed
        for (Corridori c : corridori) if (c != null) c.setSospeso(false);
    ...
    public int getVelocita() {
        return switch (jSpinner1.getValue().toString()) {
            case "Slow" -> 80;
            case "Fast" -> 10;
            default     -> 30;
        };
    ...
    /** Crea il Corridori, registra l'Observer e avvia il thread. */
